...
class SettingsManager:
    ...
    def get_device_name(self) -> str:
        ...
        return value if value else L(30073)  # "Device name"
    ...
    def reset_to_defaults(self) -> None:
        ...
        try:
            ...
            self.logger.info(L(30377))  # "Setting restored to default"
        except Exception as e:
    ...
    def validate_settings(self) -> bool:
        ...
        try:
            ...
            self.logger.info(L(30378))  # "Configuration validated"
            return True
        except Exception as e:
            self.logger.error("%s: %s", L(30379), e)  # "Configuration validation failed"
            return False

    def get_validation_status_message(self, is_valid: bool) -> str:
        """Get localized validation status message"""
        return L(30378) if is_valid else L(30379)  # "Configuration validated" or "Configuration validation failed"

    def get_setting_save_message(self, success: bool) -> str:
        """Get localized setting save message"""
        return L(30375) if success else L(30376)  # "Setting saved successfully" or "Failed to save setting"
