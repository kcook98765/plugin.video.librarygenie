        ...
        try:
            ...
            if not self.query_manager.initialize():
                ...
                return DialogResponse(
                    success=False,
                    message=L(94306)  # "Database error" (red color)
                )
            ...
            if result.get("error"):
                if result["error"] == "duplicate_name":
                    ...
                    message = L(90507)  # "Failed to create list" (red color)
    ...
    def delete_list(self, context: PluginContext, list_id: str) -> DialogResponse:
        ...
        try:
            ...
            if not list_info:
                return DialogResponse(
                    success=False,
                    message=L(97019)  # "List not found" (red color)
                )
