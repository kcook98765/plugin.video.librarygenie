...
class SearchPanel(xbmcgui.WindowXMLDialog):
    ...
    def _open_keyboard(self):
        ...
        kb = xbmc.Keyboard(self.q_edit.getLabel(), L(32519))  # "Enter search text"
        kb.doModal()
        if kb.isConfirmed():
            text = kb.getText()
    ...
    def _load_presets(self):
        ...
        if not presets:
            li = xbmcgui.ListItem(label=L(32528))
    ...
    def _save_as_preset(self):
        ...
        name_kb = xbmc.Keyboard('', L(32526))  # "Preset name"
        name_kb.doModal()
    ...
    def _save_as_default(self):
        ...
        xbmcgui.Dialog().notification('LibraryGenie', L(32527), xbmcgui.NOTIFICATION_INFO, 3000)
