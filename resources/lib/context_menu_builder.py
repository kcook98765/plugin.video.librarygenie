...
class ContextMenuBuilder:
    ...
    def build_video_context_menu(self, media_info, context=None):
        ...
        if current_list_id:
            list_item_id = media_info.get('list_item_id', '')
            if list_item_id:
                context_menu_items.append(('Remove from List', f'RunPlugin(plugin://plugin.video.librarygenie/?action=remove_from_list&list_id={current_list_id}&list_item_id={list_item_id})'))
