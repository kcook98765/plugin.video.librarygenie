...
class ListWindow(pyxbmct.AddonDialogWindow):
    ...
    def populate_list(self):
        xbmc.log(f"ListWindow: Populating list for list ID {self.list_id}...", xbmc.LOGDEBUG)
        ...
        for item in media_items:
            ...
            xbmc.log(f"ListWindow: Added item - Title: {item['title']}, Info: {item['info']}", xbmc.LOGDEBUG)
    ...
    def remove_media_item(self, media_item_id):
        xbmc.log(f"ListWindow: Removing media item ID {media_item_id} from list ID {self.list_id}...", xbmc.LOGDEBUG)
        db_manager = DatabaseManager(Config().db_path)
    ...
    def close(self):
        xbmc.log("ListWindow: Closing ListWindow...", xbmc.LOGDEBUG)
