...
• **Interactive Search UI**: Modal search with real-time refinement
• **Automatic Library Matching**: Connects results to your local Kodi library
• **Dynamic Lists & History**: Saved searches, protected history, smart updates
• **Remote API Pairing**: 8-digit code or API key; chunked/delta sync of identifiers

### Alpha Privacy & Data (Read first)

• **Only data sent from Kodi to the server:** your library's **IMDb IDs** (you must have IMDb IDs to use the Alpha) and the **free-text you type into the search box**.
...
1. Generate a pairing code in your server's dashboard
...
2. Addon Settings → **Remote API**
3. Enter **Server URL** and **API Key**, then **Test Connection**
